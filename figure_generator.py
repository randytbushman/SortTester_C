...
def run_experiments(sort_tester_binary: str, csv_dir: str):
    ...
    with ProcessPoolExecutor() as executor:
        # Figure 5 generation
        experiments.append(executor.submit(subprocess.run, f"{sort_tester_binary} --num_trials 10 --initial_length 10000 --length_increment 10000 --max_length 1000000 --min_arr_value 0 --max_arr_value 50000 --divisor 0 --figure_mode 5 --csv_file {os.path.join(csv_dir, 'fig_5_a.csv')}", shell=True, check=True))
        experiments.append(executor.submit(subprocess.run, f"{sort_tester_binary} --num_trials 10 --initial_length 10000 --length_increment 10000 --max_length 1000000 --min_arr_value 0 --max_arr_value 500000 --divisor 0 --figure_mode 5 --csv_file {os.path.join(csv_dir, 'fig_5_b.csv')}", shell=True, check=True))
        experiments.append(executor.submit(subprocess.run, f"{sort_tester_binary} --num_trials 10 --initial_length 10000 --length_increment 10000 --max_length 1000000 --min_arr_value 0 --max_arr_value 5000000 --divisor 0 --figure_mode 5 --csv_file {os.path.join(csv_dir, 'fig_5_c.csv')}", shell=True, check=True))
        experiments.append(executor.submit(subprocess.run, f"{sort_tester_binary} --num_trials 10 --initial_length 10000 --length_increment 10000 --max_length 1000000 --min_arr_value 0 --max_arr_value 50000000 --divisor 0 --figure_mode 5 --csv_file {os.path.join(csv_dir, 'fig_5_d.csv')}", shell=True, check=True))

        # Figure 6 generation
        experiments.append(executor.submit(subprocess.run, f"{sort_tester_binary} --num_trials 10 --initial_length 10 --length_increment 10 --max_length 2000 --min_arr_value 0 --max_arr_value 150000000 --divisor 0 --figure_mode 6 --csv_file {os.path.join(csv_dir, 'fig_6.csv')}", shell=True, check=True))

        # Figure 7 generation
        experiments.append(executor.submit(subprocess.run, f"{sort_tester_binary} --num_trials 10 --initial_length 10000 --length_increment 10000 --max_length 1000000 --min_arr_value 0 --max_arr_value 50000 --divisor 16 --figure_mode 7 --csv_file {os.path.join(csv_dir, 'fig_7_a.csv')}", shell=True, check=True))
        experiments.append(executor.submit(subprocess.run, f"{sort_tester_binary} --num_trials 10 --initial_length 10000 --length_increment 10000 --max_length 1000000 --min_arr_value 0 --max_arr_value 500000 --divisor 16 --figure_mode 7 --csv_file {os.path.join(csv_dir, 'fig_7_b.csv')}", shell=True, check=True))
        experiments.append(executor.submit(subprocess.run, f"{sort_tester_binary} --num_trials 10 --initial_length 10000 --length_increment 10000 --max_length 1000000 --min_arr_value 0 --max_arr_value 5000000 --divisor 16 --figure_mode 7 --csv_file {os.path.join(csv_dir, 'fig_7_c.csv')}", shell=True, check=True))
        experiments.append(executor.submit(subprocess.run, f"{sort_tester_binary} --num_trials 10 --initial_length 10000 --length_increment 10000 --max_length 1000000 --min_arr_value 0 --max_arr_value 50000000 --divisor 16 --figure_mode 7 --csv_file {os.path.join(csv_dir, 'fig_7_d.csv')}", shell=True, check=True))
...
def main() -> None:
    ...
    fig_5.savefig(f"{figure_dir}/figures_5.png", dpi=600)
    fig_6.savefig(f"{figure_dir}/figures_6.png", dpi=600)
    fig_7.savefig(f"{figure_dir}/figures_7.png", dpi=600)
